...
int main (int argc, char** argv)
{
  ...
  TF1 fitFunc("fitFunc",myV_L,myAnalyzer.getMinX(),myAnalyzer.getMaxX(),2);
  ...
  double meas1 = 0.000200001, err1 = 6.21578e-07;
  double meas2 = 0.000204668, err2 = 6.17101e-07;
  double significance = 0.05;
  if (myAnalyzer.testCompatibility(pvalue, meas1, err1, meas2, err2, significance, "Normal", 1, 1) == true)
